				...
				<Stack className="container">
					...
					<Stack className="blogPageDescr">
						<Box className="blogPageText">
							...
							<p className="descr">
								Aliquam suscipit, erat vel pharetra tempus, enim sem
								pellentesque est, dapibus efficitur lacus ipsum porttitor augue.
								Nullam sit amet vehicula ex. Vivamus ac enim eu lacus ornare
								sollicitudin. Integer lacus dui, gravida sit amet pellentesque
								sed, posuere nec eros. Pellentesque mattis viverra erat, at
						...
						<Box className="infoBox">
							...
							<p className="infoDescr">
								<ul className="elegantList">
									<li>
										Elevate Your Space with Our Classy Electrical Solutions
									</li>
