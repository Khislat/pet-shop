						...
						<Toolbar>
							<Tooltip title="Open settings">
								<IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
									<Avatar
										src={
											user?.memberImage ? `${NEXT_PUBLIC_APP_API_URL}/${user?.memberImage}` : '/img/profile/defaultUser.svg'
										}
									/>
								</IconButton>
							</Tooltip>
					...
					>
						<Toolbar sx={{ flexDirection: 'column', alignItems: 'flexStart' }}>
							<Stack className={'logo-box'}>
								<img src={'/img/logo/BOWOW.svg'} alt={'logo'} />
							</Stack>
							...
							>
								<Avatar
									src={user?.memberImage ? `${NEXT_PUBLIC_APP_API_URL}/${user?.memberImage}` : '/img/profile/defaultUser.svg'}
								/>
